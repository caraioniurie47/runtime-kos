...
namespace System.Net.Sockets.Tests
{
    public abstract class SendReceive<T> : SocketTestHelperBase<T> where T : SocketHelperBase, new()
    {
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsNotKasperskyOS))] // TODO-KOS(6q): SendBufferSize, ReceiveBufferSize = 0 fail with EINVAL, as on BSD-like stacks
        ...
        {
            SocketTestExtensions.SkipIfIPv6Unsupported(address.AddressFamily == AddressFamily.InterNetworkV6);
        ...
        {
            SocketTestExtensions.SkipIfIPv6Unsupported(ipv6Server || dualModeClient);

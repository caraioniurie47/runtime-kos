...
if (CLR_CMAKE_TARGET_KOS)
  # external/kos/endian.h: brotli includes <endian.h> for OS_LINUX, which its CMakeLists.txt sets for KOS too
  target_include_directories(brotlicommon PRIVATE ${CLR_SRC_NATIVE_DIR}/external/kos)
  target_include_directories(brotlienc PRIVATE ${CLR_SRC_NATIVE_DIR}/external/kos)
  target_include_directories(brotlidec PRIVATE ${CLR_SRC_NATIVE_DIR}/external/kos)
endif()

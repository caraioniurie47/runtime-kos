...
namespace System
{
    ...
    internal static class ConsolePal
    {
        ...
        private sealed class WindowsConsoleStream : ConsoleStream
        {
            ...
            // The console APIs read and write whole UTF-16 code units. The byte left over by a read or write of
            // an odd number of bytes is held here for the next call, so reading or writing one byte at a time

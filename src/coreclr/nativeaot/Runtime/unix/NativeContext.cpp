...
#elif defined(__KOS__) && defined(HOST_ARM64)

#define MCREG_X0(mc)      ((mc).__gregs[_REG_X0])
#define MCREG_X1(mc)      ((mc).__gregs[_REG_X1])
#define MCREG_X2(mc)      ((mc).__gregs[_REG_X2])
#define MCREG_X3(mc)      ((mc).__gregs[_REG_X3])
#define MCREG_X4(mc)      ((mc).__gregs[_REG_X4])
#define MCREG_X5(mc)      ((mc).__gregs[_REG_X5])
#define MCREG_X6(mc)      ((mc).__gregs[_REG_X6])
#define MCREG_X7(mc)      ((mc).__gregs[_REG_X7])
#define MCREG_X8(mc)      ((mc).__gregs[_REG_X8])
#define MCREG_X9(mc)      ((mc).__gregs[_REG_X9])
#define MCREG_X10(mc)     ((mc).__gregs[_REG_X10])
#define MCREG_X11(mc)     ((mc).__gregs[_REG_X11])
#define MCREG_X12(mc)     ((mc).__gregs[_REG_X12])
#define MCREG_X13(mc)     ((mc).__gregs[_REG_X13])
#define MCREG_X14(mc)     ((mc).__gregs[_REG_X14])
#define MCREG_X15(mc)     ((mc).__gregs[_REG_X15])
#define MCREG_X16(mc)     ((mc).__gregs[_REG_X16])
#define MCREG_X17(mc)     ((mc).__gregs[_REG_X17])
#define MCREG_X18(mc)     ((mc).__gregs[_REG_X18])
#define MCREG_X19(mc)     ((mc).__gregs[_REG_X19])
#define MCREG_X20(mc)     ((mc).__gregs[_REG_X20])
#define MCREG_X21(mc)     ((mc).__gregs[_REG_X21])
#define MCREG_X22(mc)     ((mc).__gregs[_REG_X22])
#define MCREG_X23(mc)     ((mc).__gregs[_REG_X23])
#define MCREG_X24(mc)     ((mc).__gregs[_REG_X24])
#define MCREG_X25(mc)     ((mc).__gregs[_REG_X25])
#define MCREG_X26(mc)     ((mc).__gregs[_REG_X26])
#define MCREG_X27(mc)     ((mc).__gregs[_REG_X27])
#define MCREG_X28(mc)     ((mc).__gregs[_REG_X28])
#define MCREG_Fp(mc)      ((mc).__gregs[_REG_FP])
#define MCREG_Lr(mc)      ((mc).__gregs[_REG_LR])
#define MCREG_Sp(mc)      ((mc).__gregs[_REG_SP])
#define MCREG_Pc(mc)      ((mc).__gregs[_REG_PC])
